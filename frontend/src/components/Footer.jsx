    ...
    <section className="section-footer container">
      {pageName === "home" ? (
        <HashLink className="footer-logo-container" to="#headerTop">
          ...
          <h1 className="footer-logo-text">CineTix</h1>
        </HashLink>
      ) : (
      ...
      <p className="copyright">
        Copyright &copy; 2025 by Sayan Mukherjee, Inc. This work is licensed under
        the terms of the{" "}
        <a href="https://github.com/SayanMukherjee24">
